...
require (
	github.com/mooyang-code/scf-framework v0.0.19
...
require (
	...
	github.com/mooyang-code/go-commlib/trpc-database/timer v0.0.2 // indirect
	github.com/mooyang-code/xData-mini/storage/proto v0.0.0 // indirect
	...
	trpc.group/trpc-go/trpc-database/localcache v1.0.0 // indirect
	trpc.group/trpc/trpc-protocol/pb/go/trpc v1.0.1 // indirect
)

replace github.com/mooyang-code/scf-framework => ../scf-framework
